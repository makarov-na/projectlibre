...
public class MSPDIReader extends AbstractProjectReader //claur removed final to extend
{
    ...
    */
   protected ResourceAssignment readAssignment(Project.Assignments.Assignment assignment, SplitTaskFactory splitFactory, TimephasedWorkNormaliser normaliser) //claur protected to extend
