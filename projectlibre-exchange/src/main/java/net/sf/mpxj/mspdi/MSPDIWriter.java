 ...
 */
public class MSPDIWriter extends AbstractProjectWriter //claur final removed
{
   /**
    ...
    * @param project Root node of the MSPDI file
    */
   protected void writeResources(Project project)  //claur protected to extend
   {
    ...
    */
   protected Project.Resources.Resource writeResource(Resource mpx)  //claur protected to extend
   {
    ...
    */
   protected Project.Tasks.Task writeTask(Task mpx) //claur protected to extend
   {
    ...
    */
   protected Project.Assignments.Assignment writeAssignment(ResourceAssignment mpx) //claur protected to extend
   {
   ...
   protected ObjectFactory m_factory;  //claur protected to extend

   protected ProjectFile m_projectFile; //claur protected to extend
