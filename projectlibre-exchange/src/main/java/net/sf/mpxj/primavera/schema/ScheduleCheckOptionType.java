...
}) public class ScheduleCheckOptionType
{
   ...
   @XmlElement(name = "BEITripwireTarget", nillable = true) protected Double beiTripwireTarget;
   @XmlElement(name = "CheckBEITripwire", nillable = true) protected Boolean checkBEITripwire;
   @XmlElement(name = "CheckHardConstraints", nillable = true) protected Boolean checkHardConstraints;
   @XmlElement(name = "CheckInvalidProgress", nillable = true) protected Boolean checkInvalidProgress;
   @XmlElement(name = "CheckLags", nillable = true) protected Boolean checkLags;
   @XmlElement(name = "CheckLargeDurations", nillable = true) protected Boolean checkLargeDurations;
   @XmlElement(name = "CheckLargeFloat", nillable = true) protected Boolean checkLargeFloat;
   @XmlElement(name = "CheckLateActivities", nillable = true) protected Boolean checkLateActivities;
   @XmlElement(name = "CheckLogic", nillable = true) protected Boolean checkLogic;
   @XmlElement(name = "CheckLongLags", nillable = true) protected Boolean checkLongLags;
   @XmlElement(name = "CheckNegativeFloat", nillable = true) protected Boolean checkNegativeFloat;
   @XmlElement(name = "CheckNegativeLags", nillable = true) protected Boolean checkNegativeLags;
   @XmlElement(name = "CheckRelationShips", nillable = true) protected Boolean checkRelationShips;
   @XmlElement(name = "CheckResources", nillable = true) protected Boolean checkResources;
   @XmlElement(name = "CheckSoftConstraints", nillable = true) protected Boolean checkSoftConstraints;
   ...
   @XmlElement(name = "PropValue") protected String propValue;
   ...
   @XmlElement(name = "ScheduleCheckData") protected String scheduleCheckData;
