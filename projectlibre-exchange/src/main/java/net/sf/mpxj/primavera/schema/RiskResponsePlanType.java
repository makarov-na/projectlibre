...
/**
 * <p>Java class for RiskResponsePlanType complex type.
 *
...
}) public class RiskResponsePlanType
{
   ...
   @XmlElement(name = "PlannedFinishDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "dateTime") protected Date plannedFinishDate;
   @XmlElement(name = "PlannedStartDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "dateTime") protected Date plannedStartDate;
   ...
   @XmlElement(name = "ResponseType") protected String responseType;
