...
}) public class GlobalPreferencesType
{
   ...
   @XmlElement(name = "GatewayApiUrl") protected String gatewayApiUrl;
   @XmlElement(name = "GatewayExportERPSyncName") protected String gatewayExportERPSyncName;
   @XmlElement(name = "GatewayExportPrimeSyncName") protected String gatewayExportPrimeSyncName;
   @XmlElement(name = "GatewayExportUnifierSyncName") protected String gatewayExportUnifierSyncName;
   @XmlElement(name = "GatewayImportERPSyncName") protected String gatewayImportERPSyncName;
   @XmlElement(name = "GatewayImportPrimeSyncName") protected String gatewayImportPrimeSyncName;
   @XmlElement(name = "GatewayImportUnifierSyncName") protected String gatewayImportUnifierSyncName;
   @XmlElement(name = "GatewayP6DeploymentName") protected String gatewayP6DeploymentName;
   @XmlElement(name = "GatewayPassword") protected String gatewayPassword;
   @XmlElement(name = "GatewayUnifierEnabled") protected Boolean gatewayUnifierEnabled;
   @XmlElement(name = "GatewayUsername") protected String gatewayUsername;
   ...
   @XmlElement(name = "PrimeSyncPassword") protected String primeSyncPassword;
   @XmlElement(name = "PrimeSyncUsername") protected String primeSyncUsername;
    ...
    *
    */
   public String getGatewayExportPrimeSyncName()
   {
      return gatewayExportPrimeSyncName;
   }
    ...
    *
    */
   public void setGatewayExportPrimeSyncName(String value)
   {
      this.gatewayExportPrimeSyncName = value;
   }
    ...
    *
    */
   public String getGatewayImportPrimeSyncName()
   {
      return gatewayImportPrimeSyncName;
   }
    ...
    *
    */
   public void setGatewayImportPrimeSyncName(String value)
   {
      this.gatewayImportPrimeSyncName = value;
   }
    ...
    *
    */
   public String getPrimeSyncPassword()
   {
      return primeSyncPassword;
   }
    ...
    *
    */
   public void setPrimeSyncPassword(String value)
   {
      this.primeSyncPassword = value;
   }
    ...
    *
    */
   public String getPrimeSyncUsername()
   {
      return primeSyncUsername;
   }
    ...
    *
    */
   public void setPrimeSyncUsername(String value)
   {
      this.primeSyncUsername = value;
   }
