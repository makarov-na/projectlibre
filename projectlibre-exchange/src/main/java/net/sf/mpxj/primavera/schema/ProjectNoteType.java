...
}) public class ProjectNoteType
{
   ...
   @XmlElement(name = "AvailableForActivity", nillable = true) protected Boolean availableForActivity;
   @XmlElement(name = "AvailableForEPS", nillable = true) protected Boolean availableForEPS;
   @XmlElement(name = "AvailableForProject", nillable = true) protected Boolean availableForProject;
   @XmlElement(name = "AvailableForWBS", nillable = true) protected Boolean availableForWBS;
