...
}) public class NotebookTopicType
{
   ...
   @XmlElement(name = "AvailableForActivity") protected Boolean availableForActivity;
   @XmlElement(name = "AvailableForEPS") protected Boolean availableForEPS;
   @XmlElement(name = "AvailableForProject") protected Boolean availableForProject;
   @XmlElement(name = "AvailableForWBS") protected Boolean availableForWBS;
