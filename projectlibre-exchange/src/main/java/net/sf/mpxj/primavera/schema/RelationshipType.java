...
}) public class RelationshipType
{
   ...
   @XmlElement(name = "PredecessorFinishDate", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "dateTime") protected Date predecessorFinishDate;
   ...
   @XmlElement(name = "PredecessorStartDate", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "dateTime") protected Date predecessorStartDate;
   ...
   @XmlElement(name = "SuccessorFinishDate", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "dateTime") protected Date successorFinishDate;
   ...
   @XmlElement(name = "SuccessorStartDate", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "dateTime") protected Date successorStartDate;
