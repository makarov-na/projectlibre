 ...
 *         &lt;element name="Privileges" type="{http://xmlns.oracle.com/Primavera/P6/V17.7/API/BusinessObjects}GlobalPrivilegesType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 ...
 *
 */
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "GlobalProfileType", propOrder =
{
   "createDate",
   "createUser",
   "isDefault",
...
}) public class GlobalProfileType
{
   ...
   @XmlElement(name = "IsSuperUser", nillable = true) protected Boolean isSuperUser;
   ...
   @XmlElement(name = "Privileges", required = true) protected GlobalPrivilegesType privileges;
